...
// Source: github.com/gururuby/shortener/internal/handler/http/api/shorturl (interfaces: ShortURLUseCase,UserUseCase)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/mock.go -package=mocks . ShortURLUseCase,UserUseCase
//
